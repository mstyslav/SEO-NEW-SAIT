...
const categories: CategorySeed[] = [
  ...
  // Дзеркала навмисно НЕ входять у цей програмний SEO-силос: напрям має власний
  // MASTER /dzerkala/ з дочірніми сторінками /dzerkala/{slug}/
  // (див. src/data/mirror-types.ts). Директорія /poslugy/dzerkala/ та її діти
  // не генеруються.
