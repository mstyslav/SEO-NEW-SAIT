...
const seeds: Seed[] = [
  ...
  {slug:'obrobka-krayky-skla',category:'Матеріали та безпека',title:'Обробка крайки скла: полірування, шліфування та фацет',focus:'Пояснюємо, як крайка впливає на безпеку та вигляд виробу.',serviceHref:'/poslugy/#full-cycle',serviceLabel:'Дізнатися про виготовлення'},
  ...
  {slug:'strukturne-sklinnya-fasadu',category:'Безрамне та фасадне скління',title:'Структурне скління фасаду: шви та безпека',focus:'Пояснюємо зовнішній вигляд, структурний герметик і контроль виробництва.',serviceHref:'/poslugy/sklyani-fasady/strukturne-sklinnya-fasadu/',serviceLabel:'Структурне скління'},
  {slug:'panoramne-sklinnya-budynku',category:'Безрамне та фасадне скління',title:'Панорамне скління будинку: тепло, сонце та безпека',focus:'Розглядаємо склопакети, профіль, перегрів і монтажні вузли.',serviceHref:'/poslugy/sklyani-fasady/sklyani-fasady-budynkiv/',serviceLabel:'Панорамне скління'},
  {slug:'bezramne-sklinnya-balkona',category:'Безрамне та фасадне скління',title:'Безрамне скління балкона: можливості й обмеження',focus:'Пояснюємо захист від опадів, вентиляцію та холодний контур.',serviceHref:'/poslugy/bezramne-sklinnya/bezramne-sklinnya-balkona/',serviceLabel:'Скління балкона'},
