...
const seeds: Seed[] = [
  {slug:'vidy-bezpechnogo-skla',category:'Матеріали та безпека',title:'Види безпечного скла для дому та бізнесу',focus:'Пояснюємо різницю між загартованим, ламінованим та армованим склом.',serviceHref:'/poslugy/',serviceLabel:'Консультація щодо скла'},
  ...
  {slug:'obrobka-krayky-skla',category:'Матеріали та безпека',title:'Обробка крайки скла: полірування, шліфування та фацет',focus:'Пояснюємо, як крайка впливає на безпеку та вигляд виробу.',serviceHref:'/poslugy/vyhotovlennya/',serviceLabel:'Дізнатися про виготовлення'},
  {slug:'otvory-vyrizy-u-skli',category:'Матеріали та безпека',title:'Отвори й вирізи у склі: що врахувати до загартування',focus:'Показуємо, чому всі отвори потрібно точно погодити до термообробки.',serviceHref:'/poslugy/proektuvannya/',serviceLabel:'Замовити проєктування'},
  {slug:'sertifikaty-ta-markuvannya-skla',category:'Матеріали та безпека',title:'Сертифікати та маркування безпечного скла',focus:'Пояснюємо, які документи й позначення варто перевіряти у виробника.',serviceHref:'/poslugy/',serviceLabel:'Отримати консультацію'},
  ...
  {slug:'doglyad-za-dushovym-sklom',category:'Душові конструкції',title:'Як доглядати за склом і фурнітурою душової',focus:'Даємо практичний регламент очищення скла, силікону та механізмів.',serviceHref:'/poslugy/servis/',serviceLabel:'Замовити сервіс'},
  ...
  {slug:'montazh-dzerkala-na-stinu',category:'Дзеркала',title:'Монтаж дзеркала на стіну: клей чи кріплення',focus:'Порівнюємо способи фіксації та вимоги до рівної сухої основи.',serviceHref:'/poslugy/montazh/',serviceLabel:'Професійний монтаж'},
  ...
  {slug:'koly-robyty-finalny-zamir',category:'Замір і монтаж',title:'Коли робити фінальний замір скляної конструкції',focus:'Пояснюємо, які чистові роботи мають бути завершені.',serviceHref:'/poslugy/zamir/',serviceLabel:'Замовити замір'},
  {slug:'yak-chytaty-kreslennya-skla',category:'Замір і монтаж',title:'Як читати креслення скляної конструкції перед погодженням',focus:'Розбираємо розміри, осі отворів, крайки, зазори та примітки.',serviceHref:'/poslugy/proektuvannya/',serviceLabel:'Проєктування'},
  {slug:'pryhovani-komunikaciyi-montazh',category:'Замір і монтаж',title:'Приховані комунікації: як підготуватися до свердління',focus:'Пояснюємо, як передати схеми теплої підлоги, труб та кабелів.',serviceHref:'/poslugy/montazh/',serviceLabel:'Замовити монтаж'},
  {slug:'vymogy-do-osnovy-pid-sklo',category:'Замір і монтаж',title:'Вимоги до стін, підлоги та стелі для монтажу скла',focus:'Розглядаємо міцність основ, площинність і закладні.',serviceHref:'/poslugy/montazh/',serviceLabel:'Консультація монтажника'},
  {slug:'dostavka-velykoformatnogo-skla',category:'Замір і монтаж',title:'Доставка й занесення великоформатного скла',focus:'Пояснюємо перевірку проходів, ліфтів, сходів і зони розвантаження.',serviceHref:'/poslugy/dostavka/',serviceLabel:'Доставка конструкцій'},
  {slug:'pryymannya-sklyanoyi-konstruktsiyi',category:'Замір і монтаж',title:'Як прийняти скляну конструкцію після монтажу',focus:'Даємо чекліст геометрії, крайок, зазорів і роботи фурнітури.',serviceHref:'/poslugy/montazh/',serviceLabel:'Професійний монтаж'},
  {slug:'sylikon-ta-germetyky-dlya-skla',category:'Замір і монтаж',title:'Силікон і герметики для скляних конструкцій',focus:'Розбираємо сумісність, підготовку шва та час полімеризації.',serviceHref:'/poslugy/montazh/',serviceLabel:'Замовити монтаж'},
  {slug:'garantiya-na-montazh-skla',category:'Замір і монтаж',title:'Гарантія на скло, фурнітуру та монтаж: що уточнити',focus:'Пояснюємо розподіл гарантій і правила звернення до сервісу.',serviceHref:'/poslugy/servis/',serviceLabel:'Сервіс Space Glass'},

  {slug:'yak-myty-sklo-bez-rozvodiv',category:'Експлуатація та догляд',title:'Як мити скло без розводів і пошкоджень',focus:'Даємо безпечну послідовність очищення скла та крайок.',serviceHref:'/poslugy/servis/',serviceLabel:'Сервіс конструкцій'},
  {slug:'doglyad-za-chornoyu-furnituroyu',category:'Експлуатація та догляд',title:'Догляд за чорною, хромованою та латунною фурнітурою',focus:'Пояснюємо, які засоби не пошкоджують декоративні покриття.',serviceHref:'/poslugy/servis/',serviceLabel:'Замовити сервіс'},
  {slug:'vapnyanyi-nalit-na-skli',category:'Експлуатація та догляд',title:'Як прибрати вапняний наліт із душового скла',focus:'Розбираємо регулярне очищення та безпечні засоби проти відкладень.',serviceHref:'/poslugy/servis/',serviceLabel:'Догляд за душовою'},
  {slug:'regulyuvannya-sklyanyh-dverey',category:'Експлуатація та догляд',title:'Коли потрібне регулювання скляних дверей',focus:'Описуємо ознаки просідання, люфту й неправильного притвору.',serviceHref:'/poslugy/servis/',serviceLabel:'Регулювання дверей'},
  {slug:'zaminy-ushchilnyuvachiv-dushovoyi',category:'Експлуатація та догляд',title:'Коли міняти ущільнювачі у скляній душовій',focus:'Пояснюємо зношення магнітів, нижніх планок і водовідбійників.',serviceHref:'/poslugy/servis/',serviceLabel:'Сервіс душової'},
  {slug:'doglyad-za-rozsuvnymy-systemamy',category:'Експлуатація та догляд',title:'Догляд за роликами та напрямними розсувних систем',focus:'Даємо регламент очищення треків і перевірки стопорів.',serviceHref:'/poslugy/servis/',serviceLabel:'Сервіс розсувних систем'},
  ...
  {slug:'oglyad-sklyanoyi-ogorozhi',category:'Експлуатація та догляд',title:'Періодичний огляд скляної огорожі: чекліст безпеки',focus:'Описуємо контроль кріплень, крайок, поручня і герметизації.',serviceHref:'/poslugy/servis/',serviceLabel:'Огляд огорожі'},
  {slug:'yak-zberegty-sklo-pid-chas-remontu',category:'Експлуатація та догляд',title:'Як захистити скляні конструкції під час ремонту',focus:'Пояснюємо безпечне укриття скла, фурнітури та напрямних.',serviceHref:'/poslugy/servis/',serviceLabel:'Консультація сервісу'},
